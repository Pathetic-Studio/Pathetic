...
export type AllSanitySchemaTypes = CentralTextBlock | PageLoader | PageHeader | SectionSpacer | AllPosts | FormNewsletter | Faqs | LogoCloud1 | Cta1 | Timelines1 | TimelineRow | Carousel2 | Carousel1 | ImageCard | ObjectDetectImage | GridRowGrab | GridRowImage | GridRow | GridRowAnimated | GridTextBlock | GridPost | PricingCard | GridCard | GridCardAnimated | SplitCardsListAnimated | SplitRowAnimated | SplitInfo | SplitInfoList | SplitImageAnimate | SplitImage | SplitCard | SplitCardsList | SplitContent | SplitRow | SectionHeader | Hero2 | SectionAnchor | Hero1 | Background | HeroFeature | SectionPadding | ButtonVariant | ColorVariant | Link | ContactSubmission | BlockContent | MemeBooth | Settings | Navigation | Testimonial | Faq | Category | Page | Post | Author | Code | Color | RgbaColor | HsvaColor | HslaColor | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageHotspot | SanityImageCrop | SanityFileAsset | SanityImageAsset | SanityImageMetadata | Geopoint | Slug | SanityAssetSourceData;
