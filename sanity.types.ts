...
// Query: *[_type == "memeBooth" && _id == "memeBooth"][0]{    title,    subtitle,    showNewsletterModalOnView,    meta_title,    meta_description,    noindex,    ogImage {      asset->{        _id,        url,        metadata {          dimensions {            width,            height          }        }      },    }  }
